...
<div class="page-top-info">
    <div class="container">
        ...
        <div class="site-pagination">
            ...
            <a href="../view/category.php">Shop</a>
        </div>
    </div>
</div>
<!-- Page info end -->
...
<section class="product-section">
    <div class="container">
<!--        <div class="back-link">-->
<!--            <a href="admin_category.php"> &lt;&lt; Back to Category</a>-->
<!--        </div>-->
        <div class="row">
            <div class="col-lg-6">
                <div class="product-pic-zoom">
                    <img class="product-big-img" src="../assets/img/single-product/1.jpg" alt="">
                </div>
