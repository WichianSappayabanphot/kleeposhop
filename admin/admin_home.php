...
<html lang="en">
<head>
    <title>KPS | Admin home page</title>
...
<section class="hero-section">
    <div class="hero-slider owl-carousel">
        <div class="hs-item set-bg" data-setbg="../assets/img/new.jpg">
            <div class="container">
                <div class="row">
                ...
                <a href="#">
                    <div class="feature-inner">
                        <div class="feature-icon">
                            <img src="../assets/img/icons/4.png" style="width: 50px; height: 50px;" alt="#">
                        </div>
                        <h2>CLOTHS STORE</h2>
                    </div>
                </a>
